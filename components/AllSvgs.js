  ...
  export const WolfIcon = (props) => { 
    return ( 
      ...
      >
        ...
        >
          <path d="M0 171.992V0h171.992v171.992z" />
          <g fillRule="evenodd">
            <ellipse
              cx={24}
              cy={24.005}
              transform="scale(3.5625)"
              rx={20}
              ry={19.992}
              fill="#212121"
            />
            <path
              d="M88.354 54.927C81.877 42.052 71.752 33.812 60.498 27c14.375-3.659 29.22-2.472 44.532 3.563l6.597 14.25z"
              fill="#942a2a"
            />
            <path
              d="M38.24 32.198C27.125 44.517 20.356 60.83 20.356 78.706c0 38.34 31.13 69.47 69.469 69.47 28.76 0 52.066-16.317 62.614-41.248-8.731 29.487-34.641 49.822-66.939 49.822-39.323 0-71.25-31.927-71.25-71.25 0-21.197 9.277-40.242 23.99-53.302z"
              fill="#8d0000"
            />
            <path
              d="M85.265 14.25h.235c39.323 0 71.25 31.927 71.25 71.25s-31.927 71.25-71.25 71.25c-10.125 0-19.761-2.116-28.482-5.932 18.746-7.623 34.228-18.827 42.703-36.807 0 0-21.749 10.705-34.563 10.705-11.867 0-22.258-13.926-28.653-24.09a6.306 6.306 0 0 1-.31-6.106 6.32 6.32 0 0 1 5.016-3.502c8.956-.947 20.602-5.571 30.039-12.312 8.529-6.092 7.802-15.543 17.385-24.937 4.628-4.535 12.337-8.105 18.425-11.023-6.003-10.455-12.55-19.65-21.795-28.496z"
              fill="#ff3535"
            />
          </g>
        </g>
